...
class WaitlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waitlist" do
    assert_difference('Waitlist.count') do
      post waitlists_url, params: { waitlist: { num_seats: @waitlist.num_seats, tour_id: @waitlist.tour_id, user_id: @waitlist.user_id } }
    end
  ...
  test "should update waitlist" do
    patch waitlist_url(@waitlist), params: { waitlist: { num_seats: @waitlist.num_seats, tour_id: @waitlist.tour_id, user_id: @waitlist.user_id } }
