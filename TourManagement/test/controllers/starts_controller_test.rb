...
class StartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create start" do
    assert_difference('Start.count') do
      post starts_url, params: { start: { location_id: @start.location_id, tour_id: @start.tour_id } }
    end
  ...
  test "should update start" do
    patch start_url(@start), params: { start: { location_id: @start.location_id, tour_id: @start.tour_id } }
